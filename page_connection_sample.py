...
class Window(QMainWindow): # 메인화면 기본적인 크기와 위치, GUI 불러오기
    def __init__(self):
        super().__init__()
        self.title = "App"
        self.top = 100
    ...
    def buttonWindow1_onClick(self):
        ...
        self.cams = Window1(self.lineEdit1.text()) # 홈 화면에 정의된 lineEdit1객체에서  text()를 추출해서 가지고 간다.
        self.cams.show()
        self.close()
    ...
    def buttonWindow2_onClick(self):
        ...
        self.cams = Window2(self.lineEdit2.text()) #window2 창으로 객체 만들어서// lineEdit2 는 홈화면의 lineEdit2의 text()를 가지고 온거다.
        self.cams.show() #show() 함수로 보여주기
        self.close()
...
class Window1(QDialog):
    ...
    def goMainWindow(self):
        self.cams = Window() #홈화면 클래스로 객체 만들어서
        self.cams.show() #객체 만든걸로 보여주기
        self.close()
